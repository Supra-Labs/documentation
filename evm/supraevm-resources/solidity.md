---
description: >-
  Understand how Solidity works and start building smart contracts across the
  EVM ecosystem.
---
...
### What is Solidity? <a href="#what-is-solidity" id="what-is-solidity"></a>

_A high-level programming language for writing smart contracts on EVM-based blockchains._
...
### Why Learn Solidity? <a href="#why-learn-solidity" id="why-learn-solidity"></a>

_Because Solidity opens the door to creating decentralized applications across the EVM ecosystem._
...
### How Does Solidity Work? <a href="#how-does-solidity-work" id="how-does-solidity-work"></a>

_Write code, compile it, deploy it, and let the EVM handle execution._
...
### What Can You Build With Solidity? <a href="#what-can-you-build-with-solidity" id="what-can-you-build-with-solidity"></a>
